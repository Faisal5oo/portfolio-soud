...
function ContactForm() {
  ...
  return (
    <div>
      ...
      <div className="max-w-3xl text-white rounded-lg border border-purple/30 p-3 lg:p-5 bg-black/50">
        <p className="text-sm text-white">{"If you have any questions or concerns, please don't hesitate to contact me. I am open to any work opportunities that align with my skills and interests."}</p>
